...
def save_topic_results(topic_info, topic_summary, filename):
...
# Function to create interactive visualizations for each question
def create_interactive_visualization(topic_info, topic_summary, question):
    fig = go.Figure()
...
if __name__ == "__main__":
    ...
    for question, col in question_mapping.items():
        ...
        save_topic_results(topic_info, topic_summary, f"topic_analysis_results_{col}.txt")
        
        # Create interactive visualization
        create_interactive_visualization(topic_info, topic_summary, question)
        
        print(f"Topic analysis results for {question} have been written to 'topic_analysis_results_{col}.txt'.")
        print(f"Interactive visualizations for {question} have been generated.")
